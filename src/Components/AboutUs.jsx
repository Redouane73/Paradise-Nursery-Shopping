  ...
  return (
    <div className="aboutus-container">
      ...
      <p>
        ...
        not only enhance the beauty of your surrounding but contributes to a
        healthier and more sustainable lifestyle. From air-purifying plants to
        aromatic fragnant ones, we have something gor every plant enthusiast.
      </p>
      <p>
        Our team of experts is dedicated to ensuring that each plant meets our
        strict standards of quality and care. Whether you're a seasoned gardner
