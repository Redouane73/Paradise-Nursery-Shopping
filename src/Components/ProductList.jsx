...
function ProductList() {
  const [showCart, setShowCart] = useState(false); // State to control the visibility of the product list page
  const [showPlants, setShowPlants] = useState(false); // State to control the visibility of the About Us page
  const [addedToCart, setAddedToCart] = useState({}); // State to control the added items to the cart
  ...
  const handleCartClick = (e) => {
    e.preventDefault();
    setShowCart(true); // Set showCart to true when shopping cart icon is clicked and navigate to cart items page
  };
  const handlePlantsClick = (e) => {
    e.preventDefault();
    setShowPlants(true); // Set show plants to true when "plants" link is clicked
          ...
          <div className="items-information">
            <div className="product-container">
              {plantsArray.map((category, index) => (
                <div key={index}>
                  <h1>
                    <div className="plant-cat">{category.category}</div>
                  </h1>
